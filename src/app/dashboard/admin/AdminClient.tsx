        ...
        <div className="max-w-7xl mx-auto h-full px-4 md:px-6 flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-1.5">
            {[
              ...
              { label: '📚 Curriculum', href: '/dashboard/admin/curriculum' },
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-24 pb-16 relative">
        ...
        >
          {[
            ...
            { label: 'কারিকুলাম', value: stats.totalSubjects, icon: '📚', linear: 'from-violet-500 to-purple-400', href: '/dashboard/admin/curriculum' },
          ].map((stat, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
