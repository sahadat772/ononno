...
export default function DeleteLessonModal({ open, lesson, onClose, onSuccess }: Props) {
    ...
    async function handleDelete() {
        ...
        try {
            ...
            if (!res.ok) {
                setError(data.error || 'Lesson মুছে ফেলা যায়নি।')
                setLoading(false)
                return
            }
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-sm text-center mb-6">
                            <span className="text-white font-semibold">{lesson.title_bn}</span> ({lesson.title}) lesson টি inactive হয়ে যাবে।
                        </p>
