...
export default function DeleteSubjectModal({ open, subject, onClose, onSuccess }: Props) {
    ...
    async function handleDelete() {
        ...
        try {
            ...
            if (!res.ok) {
                setError(data.error || 'Subject মুছে ফেলা যায়নি।')
                setLoading(false)
                return
            }
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-sm text-center mb-6">
                            <span className="text-white font-semibold">{subject.name_bn}</span> ({subject.name}) subject টি inactive হয়ে যাবে। এই subject এর chapters ও lessons affected হবে।
                        </p>
