...
export default function EnglishABCPage() {
    ...
    // Card view: auto-speak current letter
    useEffect(() => {
        if (activeView !== 'card') return
        const item = alphabets[cardIndex]
        if (item) speak(`${item.letter}. ${item.word}`, 'en-US')
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [cardIndex, activeView])

    const handleLetterClick = (letter: typeof alphabets[0]) => {
        setSelectedLetter(letter)
        // AI voice: letter + word
        speak(`${letter.letter}. ${letter.word}`, 'en-US')
        ...
        <div className="min-h-screen bg-gradient-to-b from-[#0d0a2e] via-[#0a1628] to-[#0a0a1a] text-white">
            ...
            <div className="max-w-2xl mx-auto px-4 py-6">
                ...
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-6">
                    ...
                    <p className="text-gray-400 text-sm">Letter click করো — শুনবে AI voice!</p>
                </motion.div>
                                    ...
                                    <div className="flex items-center justify-center gap-6 mb-4">
                                        ...
                                        <div className="text-left">
                                            ...
                                            <button
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation()
                                                    speak(`${selectedLetter.letter}. ${selectedLetter.word}`, 'en-US')
                                                }}
                        ...
                        <div className="flex justify-center gap-1 flex-wrap max-w-xs mx-auto">
                            {alphabets.map((_, i) => (
                                <button
                                    ...
                                    className={`w-2 h-2 rounded-full transition-all ${i === cardIndex ? 'bg-cyan-400 w-4' : 'bg-white/20'}`}
                ...
                <div className="mt-8 rounded-2xl bg-white/5 border border-white/10 p-4">
                    ...
                    <div className="h-2.5 rounded-full bg-white/10">
                        <div
                            className="h-2.5 rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 transition-all"
