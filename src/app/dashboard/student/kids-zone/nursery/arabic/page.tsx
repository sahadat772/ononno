...
const units = [
  ...
  { id: 5, title: 'হরকত শিখি', subtitle: 'ফাতহা · কাসরা · দাম্মা', icon: '🌟', color: 'from-rose-400 to-pink-500', bg: 'bg-rose-500/10', border: 'border-rose-500/30',
    lessons: [
      { id: 'arabic-fatha', title: 'فَ — যবর', icon: 'فَ', xp: 15 }, { id: 'arabic-kasra', title: 'فِ — যের', icon: 'فِ', xp: 15 },
      { id: 'arabic-damma', title: 'فُ — পেশ', icon: 'فُ', xp: 15 },
