...
const units = [
    {
        ...
        lessons: [
            { id: 'math-1', title: '১ — এক', icon: '১', xp: 10 },
            { id: 'math-2', title: '২ — দুই', icon: '২', xp: 10 },
            { id: 'math-3', title: '৩ — তিন', icon: '৩', xp: 10 },
            { id: 'math-4', title: '৪ — চার', icon: '৪', xp: 10 },
            { id: 'math-5', title: '৫ — পাঁচ', icon: '৫', xp: 10 },
            { id: 'math-6', title: '৬ — ছয়', icon: '৬', xp: 10 },
            { id: 'math-7', title: '৭ — সাত', icon: '৭', xp: 10 },
            { id: 'math-8', title: '৮ — আট', icon: '৮', xp: 10 },
            { id: 'math-9', title: '৯ — নয়', icon: '৯', xp: 10 },
            { id: 'math-10', title: '১০ — দশ', icon: '🔟', xp: 10 },
        ],
    ...
    },
    {
        ...
        lessons: [
            { id: 'math-add-1', title: '১+১ = ২', icon: '➕', xp: 15 },
            { id: 'math-add-2', title: '২+২ = ৪', icon: '➕', xp: 15 },
            { id: 'math-add-3', title: '৩+৩ = ৬', icon: '➕', xp: 15 },
            { id: 'math-add-4', title: '৪+৪ = ৮', icon: '➕', xp: 15 },
    ...
    },
    {
        ...
        lessons: [
            { id: 'math-sub-1', title: '৫-১ = ৪', icon: '➖', xp: 15 },
            { id: 'math-sub-2', title: '৬-২ = ৪', icon: '➖', xp: 15 },
            { id: 'math-sub-3', title: '৮-৩ = ৫', icon: '➖', xp: 15 },
            { id: 'math-sub-4', title: '১০-৫ = ৫', icon: '➖', xp: 15 },
        ],
    ...
    return (
        <div className="min-h-screen bg-linear-to-b from-[#0d0a2e] via-[#0a1628] to-[#0a0a1a] text-white pb-10">
            ...
            <div className="max-w-2xl mx-auto px-4 pt-5">
                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-gray-400 text-sm">সংখ্যা গণনা, যোগ আর বিয়োগ শিখি!</p>
                            <div className="mt-2">
                                                        ...
                                                        <div className={`rounded-2xl border-2 border-dashed p-4 flex items-center gap-3 ${allComplete ? 'border-amber-500/50 bg-amber-500/10' : 'border-gray-600 bg-gray-800/30 opacity-50'}`}>
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                ...
                                                                <p className="text-xs text-gray-400">
                                                                    {allComplete ? '🎉 তুমি Boss Quiz দিতে পারবে!' : 'সব lesson শেষ করলে unlock হবে'}
                                                                </p>
                                                            </div>
                ...
                >
                    <p className="text-amber-300 font-semibold mb-1">🧮 গণিত মজার!</p>
                    <p className="text-gray-400 text-sm">একটা lesson শেষ করলে পরেরটা unlock হবে। তুমি পারবেই! 💪</p>
                </motion.div>
            </div>
        </div>
    )
