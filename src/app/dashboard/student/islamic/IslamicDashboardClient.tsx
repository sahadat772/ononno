...
const ISLAMIC_MODULES = [
    ...
    },
    {
        ...
        title: 'তাজবিদ',
        title_ar: 'التجويد',
        desc: 'তাজবিদ নিয়ম, AI কণ্ঠ চেক, স্কোর',
    ...
    },
    {
        ...
        title: 'দোয়া',
        title_ar: 'الدعاء',
        desc: 'পরিস্থিতি অনুযায়ী দোয়া · AI সাহায্য',
    ...
    },
    {
        ...
        title: 'অগ্রগতি',
        title_ar: 'التقدم',
        desc: 'সাপ্তাহিক বিশ্লেষণ, অভিভাবক রিপোর্ট',
        ...
        <div className="min-h-screen bg-gradient-to-b from-[#0d0a2e] via-[#0a1628] to-[#0a0a1a] text-white">
            ...
            <div className="max-w-2xl mx-auto px-4 py-6">
                ...
                >
                    ...
                    >🕌</motion.div>
                    <h1 className="text-3xl font-bold text-white mb-1">ইসলামিক হাব</h1>
                    <p className="text-2xl text-emerald-300 mb-1">العلم الإسلامي</p>
                ...
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="mb-6 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 p-4"
                >
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        {[
                            { icon: '📖', label: 'আয়াত', value: todayTracker?.quran_ayahs_read || 0, done: (todayTracker?.quran_ayahs_read || 0) > 0 },
                            { icon: '🤲', label: 'দোয়া', value: todayTracker?.duas_recited || 0, done: (todayTracker?.duas_recited || 0) > 0 },
                            { icon: '📜', label: 'হাদিস', value: todayTracker?.hadith_read || 0, done: (todayTracker?.hadith_read || 0) > 0 },
                            { icon: '🎵', label: 'তাজবিদ', value: todayTracker?.tajweed_practiced ? '✅' : '—', done: todayTracker?.tajweed_practiced || false },
                        ].map((item, i) => (
                            <div
                                key={i}
                ...
                {progressData.length > 0 && (
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        ...
                        <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-3 text-center">
                            ...
                            <p className="text-gray-400 text-xs">চলমান</p>
                        </div>
                    </div>
                )}
                ...
                >
                    <Link href="/dashboard/student/islamic/chat">
                        <motion.div
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="rounded-2xl bg-gradient-to-r from-violet-500/20 to-purple-500/20 border border-violet-500/30 p-4 flex items-center gap-4"
                        >
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">
                                    যেকোনো ইসলামিক প্রশ্ন করো — কুরআন ও হাদিস রেফারেন্স সহ
                                </p>
                            </div>
                            <span className="ml-auto text-violet-400 text-xl shrink-0">→</span>
                        </motion.div>
                    </Link>
                </motion.div>
                        ...
                        >
                            <Link href={module.href}>
                                <motion.div
                                    ...
                                    whileTap={{ scale: 0.99 }}
                                    className={`min-h-[72px] rounded-2xl ${module.bg} border ${module.border} p-4 flex items-center gap-4 active:scale-[0.99] transition`}
                                >
                                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${module.color} flex items-center justify-center text-2xl shrink-0 shadow-lg`}>
                                        {module.icon}
                                    </div>
